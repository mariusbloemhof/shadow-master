...
public abstract class AppTour extends AppCompatActivity {
    ...
    private RelativeLayout customBottomPanel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        customBottomPanel = (RelativeLayout) findViewById(R.id.CustomBottomPanel);
        customBottomPanel.setVisibility(View.INVISIBLE);
        RelativeLayout.LayoutParams params = (RelativeLayout.LayoutParams) controlsRelativeLayout.getLayoutParams();
        params.addRule(RelativeLayout.ALIGN_PARENT_BOTTOM, R.id.backgroundRelativeLayout);
        ...
        activeDotColor = Color.LTGRAY;
        inactiveDocsColor = Color.DKGRAY;
    ...
    /**
     * Hide the Custom bottom panel
     */
    public void ShowCustomBottomPanel(Fragment fragment) {
        customBottomPanel.setVisibility(View.VISIBLE);
        RelativeLayout.LayoutParams params = (RelativeLayout.LayoutParams) controlsRelativeLayout.getLayoutParams();
        params.removeRule(RelativeLayout.ALIGN_PARENT_BOTTOM);
        params.addRule(RelativeLayout.ABOVE, R.id.CustomBottomPanel);

        FragmentManager fragmentManager = getSupportFragmentManager();
        FragmentTransaction transaction = fragmentManager.beginTransaction();
        transaction.add(R.id.CustomBottomPanel, fragment, "customFragment");
